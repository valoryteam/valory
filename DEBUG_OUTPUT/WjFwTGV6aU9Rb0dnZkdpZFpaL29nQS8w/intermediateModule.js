...
var f1901113617 = function(data, dataPath, parentData, parentDataProperty, rootData) {
    let validationErrors = null; /**@const*/
    const schema = {
        "properties": {
            "body": {
    ...
    if ((data && typeof data === "object" && !Array.isArray(data))) {
        if (true) {
            ...
            if (data1 === undefined) {
                valid1 = false;
                return 'ValidationError[required]: request.body is a required property';
            } else {
                var errs_1 = errors;
                if ((data1 && typeof data1 === "object" && !Array.isArray(data1))) {
                        ...
                        if (data2 === undefined) {
                            ...
                            if (typeof data2 !== "string") {
                                ...
                                if (coerced2 === undefined) {
                                    return 'ValidationError[type]: request.body.merchant_ref should be string';
                                } else {
                                    data2 = coerced2;
                        ...
                        if (valid2) {
                            ...
                            if (data2 === undefined) {
                                ...
                                if (typeof data2 !== "string") {
                                    ...
                                    if (coerced2 === undefined) {
                                        return 'ValidationError[type]: request.body.transaction_type should be string';
                                    } else {
                                        data2 = coerced2;
                            ...
                            if (valid2) {
                                ...
                                if (data2 === undefined) {
                                    valid2 = false;
                                    return 'ValidationError[required]: request.body.method is a required property';
                                } else {
                                    var errs_2 = errors;
                                    if (typeof data2 !== "string") {
                                        var dataType2 = typeof data2;
                                        ...
                                        if (coerced2 === undefined) {
                                            return 'ValidationError[type]: request.body.method should be string';
                                        } else {
                                            data2 = coerced2;
                                ...
                                if (valid2) {
                                    ...
                                    if (data2 === undefined) {
                                        valid2 = false;
                                        return 'ValidationError[required]: request.body.amount is a required property';
                                    } else {
                                        var errs_2 = errors;
                                        if (typeof data2 !== "string") {
                                            var dataType2 = typeof data2;
                                            ...
                                            if (coerced2 === undefined) {
                                                return 'ValidationError[type]: request.body.amount should be string';
                                            } else {
                                                data2 = coerced2;
                    ...
                    return 'ValidationError[type]: request.body should be object';
                }
                if (errors === errs_1) {
                    var errs__1 = errors,
                        prevValid1 = false,
        ...
        return 'ValidationError[type]: request#/type should be object';
    }
